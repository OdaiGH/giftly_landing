          ...
          <div className="section-shell form-page-grid">
            <div className="form-intro">
              ...
              <div className="contact-mini-list">
                ...
                <div><span>☎</span><p><strong>{ar ? "الدعم" : "Support"}</strong><small dir="ltr">0553111551</small></p></div>
                <div><span>☎</span><p><strong>{ar ? "الأعمال" : "Business"}</strong><small dir="ltr">0555025551</small></p></div>
              </div>
            </div>
            <div className="form-card">
              {submitted ? (
